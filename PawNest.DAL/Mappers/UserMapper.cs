        ...
        public UserMapper()
        {
            ...
            CreateMap<User, GetFreelancerResponse>()
                ...
                .ForMember(dest => dest.Services,
                    opt => opt.MapFrom(src => src.Services)) // ICollection<Service> -> List<Service>
                .ForMember(dest => dest.ReviewsReceived,
                    opt => opt.MapFrom(src => src.ReviewsReceived)); // ICollection<Review> -> List<Review>
            ...
            CreateMap<Booking, GetBookingResponse>()
                .ForMember(dest => dest.Pets, opt => opt.MapFrom(src => src.Pets.Select(bp => bp.PetName).ToList()));
        }
    }
}